...
internal partial interface IPushToNuget : INugetHelper
{
    ...
    Target PushToNuget =>
        d => d
            ...
            .ConsumesArtifact<IPackGitVersioningExtension>(IPackGitVersioningExtension.GitVersioningExtensionProjectName)
            .RequiresParam(Atom.Build.Params.NugetFeed)
            .RequiresParam(Atom.Build.Secrets.NugetApiKey)
            .Executes(async () =>
            {
                ...
                await PushProject(IPackGitVersioningExtension.GitVersioningExtensionProjectName, NugetFeed, NugetApiKey);
            });
}