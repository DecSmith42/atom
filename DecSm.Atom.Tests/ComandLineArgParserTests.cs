...
public class ComandLineArgParserTests
{
    ...
    public void Parse_Help_Arg(string arg)
    {
        ...
        parsedArgs.Args[0].ShouldBeOfType<HelpArg>();
    }
    ...
    public void Parse_Gen_Arg(string arg)
    {
        ...
        parsedArgs.Args.ShouldHaveSingleItem();
        parsedArgs.Args[0].ShouldBeOfType<GenArg>();
    }
    ...
    public void Parse_Skip_Arg(string arg)
    {
        ...
        parsedArgs.Args.ShouldHaveSingleItem();
        parsedArgs.Args[0].ShouldBeOfType<SkipArg>();
    }
    ...
    public void Parse_Params_Arg(string arg, string argName, string paramName)
    {
        ...
        A.CallTo(() => build.ParamDefinitions).Returns(new()
        {
            ...
            ["Param2"] = new("Param2", typeof(ComandLineArgParserTests), new("param2", "Param 2")),
            ["Param3"] = new("Param3", typeof(ComandLineArgParserTests), new("param3", "Param 3")),
        });
    ...
    public void Parse_Complex_1()
    {
        ...
        parsedArgs.Args.ShouldSatisfyAllConditions(
            args => args.Length.ShouldBe(4),
            args => args[0].ShouldBeOfType<HelpArg>(),
            args => args[1]
                .ShouldBeOfType<ParamArg>()
                .ShouldSatisfyAllConditions(
                    x => x.ArgName.ShouldBe("param1"),
                    x => x.ParamName.ShouldBe("Param1"),
                    x => x.ParamValue.ShouldBe("value1")),
            args => args[2]
                .ShouldBeOfType<ParamArg>()
                .ShouldSatisfyAllConditions(
                    x => x.ArgName.ShouldBe("param2"),
                    x => x.ParamName.ShouldBe("Param2"),
                    x => x.ParamValue.ShouldBe("value2")),
            args => args[3]
                .ShouldBeOfType<CommandArg>()
                .ShouldSatisfyAllConditions(
                    x => x.Name.ShouldBe("Command1")));
    }
    ...
    public void Parse_Complex_2()
    {
        ...
        parsedArgs.Args.ShouldSatisfyAllConditions(
            ...
            args => args[2]
                ...
                .ShouldSatisfyAllConditions(
                    x => x.Name.ShouldBe("Command1")),
            args => args[3].ShouldBeOfType<SkipArg>());
    }
