...
public class TargetDefinitionSourceGenerator : IIncrementalGenerator
{
        ...
        InterfaceDeclarationSyntax interfaceDeclarationSyntax)
    {
        ...
        // E.g.
        // [ParamDefinition("my-param", "The param.", "DEFAULT_VALUE")]
        // partial string MyParam { get; }
        // Generates:
        // partial string MyParam => GetParam(() => MyParam, "DEFAULT_VALUE");

        // var paramDefinitions = interfaceDeclarationSyntax
        //     .Members
        //     .OfType<PropertyDeclarationSyntax>()
        //     .Where(pds => pds.Modifiers.Any(SyntaxKind.PartialKeyword))
        //     .Select(property =>
        //     {
        //         var paramName = property.Identifier.Text;
        //         var defaultValue = property.Initializer?.Value.ToString() ?? "null";
        //         var isNullable = property.Type is NullableTypeSyntax;
        //
        //         var nullableTypeModifier = isNullable
        //             ? "?"
        //             : string.Empty;
        //
        //         var nullableTypeModifierForDefaultValue = isNullable
        //             ? string.Empty
        //             : "!";
        //
        //         return
        //             $"    partial {property.Type}{nullableTypeModifier} {paramName} => GetParam(() => {paramName}, {defaultValue}{nullableTypeModifierForDefaultValue});";
        //     });
