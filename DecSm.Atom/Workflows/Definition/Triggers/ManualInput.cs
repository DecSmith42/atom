...
/// </summary>
/// <param name="Name">
///     The programmatic name of the input. This is often used as an identifier in scripts or
///     configurations.
/// </param>
/// <param name="Description">
///     A user-friendly description of the input, explaining its purpose and what kind of data is
///     expected.
/// </param>
/// <param name="Required">
