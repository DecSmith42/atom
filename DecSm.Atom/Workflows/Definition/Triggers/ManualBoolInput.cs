...
/// </summary>
/// <param name="Name">
///     The name of the input parameter. This will be used to identify the input when the workflow is
///     triggered.
/// </param>
...
///     The default value for the input parameter if no value is explicitly provided. Can be null,
///     true, or false.
/// </param>
[PublicAPI]
    ...
    : ManualInput(Name, Description, Required)
{
    ...
    ///     Ensure <paramref name="paramDefinition" />.DefaultValue is a valid boolean string (e.g., "true", "false") if not
    ///     null.
    /// </remarks>
