...
///     For example, one dimension could be "OperatingSystem" with values ["Windows", "Linux", "MacOS"], and another could be "DotNetVersion"
///     with values ["net8.0", "net9.0"].
///     This allows for running the same set of tasks (jobs) across different configurations.
///     The <c>Name</c> parameter is crucial for identifying the dimension, and the <c>Values</c> parameter provides the set of variations for
///     that dimension.
/// </remarks>
[PublicAPI]
