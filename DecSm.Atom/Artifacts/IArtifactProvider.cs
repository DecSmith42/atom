...
public interface IArtifactProvider
{
    ...
    ///     A list of names for the artifacts to be uploaded. Each name typically corresponds to a directory or a set of
    ///     files.
    /// </param>
    /// <param name="buildId">
    ///     The unique identifier for the current build. If not provided, the provider should attempt to use the current run's
    ///     ID.
    /// </param>
    ...
    /// </summary>
    /// <remarks>
    ///     Artifacts that are retrieved are expected to be placed in the directory specified by
    ///     <see cref="IAtomFileSystem.AtomArtifactsDirectory" />.
